...
global.owner = process.env.OWNER_NUMBER  || '923023634808' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Kashif:kashif@cluster3.0blvjsn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "923023634808" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"K♥︎❚❚♥︎B",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '15_07_2024_SIGMA_MD_TXDH6CZw_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝐊𝐀𝐒𝐇𝐈𝐅:𝘽𝘼𝙇𝙊𝘾𝙃・',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝐊𝐀𝐒𝐇𝐈𝐅-bot" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*•𝐊𝐀𝐒𝐇𝐈𝐅-м∂ мυℓтι-∂єνι¢є*\n*• ωнαтѕαρρ вσт* ",
  LANG: process.env.THEME || "𝐊𝐀𝐒𝐇𝐈𝐅_MD",
